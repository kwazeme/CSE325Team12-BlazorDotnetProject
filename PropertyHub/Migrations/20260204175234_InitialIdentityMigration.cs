        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leases_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Description", "IsCompleted", "ListingId", "ScheduledDate", "Title" },
                values: new object[] { 1, "", false, 101, new DateTime(2026, 2, 2, 0, 0, 0, 0, DateTimeKind.Utc), "Leaking Faucet" });
